...
.dev-console { width:100%; height:100%; min-width:0; min-height:0; display:flex; flex-direction:column;
  font-family:"Space Mono","Courier New",monospace; font-size:var(--text-xs); color:var(--primary,#C8D6E5); }
...
.dev-console-filter-search { flex:1; min-width:60px; background:var(--card-bg,#0F141A); color:var(--primary,#C8D6E5);
  border:1px dashed var(--border,#2A3442); border-radius:4px; padding:2px 6px; font-family:inherit; font-size:var(--text-xs); }
.dev-console-filter-level { background:var(--card-bg,#0F141A); color:var(--tertiary,#8A97A8);
  border:1px solid var(--border,#2A3442); border-radius:4px; font-family:inherit; font-size:var(--text-xs); padding:1px 4px; }
...
.dev-console-filter-clear { background:none; border:1px solid var(--border,#2A3442); border-radius:4px;
  font-family:inherit; font-size:var(--text-xs); color:var(--tertiary,#8A97A8); cursor:pointer; padding:1px 6px; }
.dev-console-specs-run { background:var(--accent,#00E5FF); color:#06121A; border:none; border-radius:4px;
  font-family:inherit; font-size:var(--text-xs); font-weight:700; padding:2px 8px; cursor:pointer; white-space:nowrap; }
...
.dev-console-cell-cat { text-transform:uppercase; font-size:var(--text-2xs); font-weight:700; letter-spacing:0.5px; align-self:center; }
...
.dev-console-cell-kind { text-transform:uppercase; font-size:var(--text-2xs); align-self:center; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
